    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.RemoveLoginSuccess ? "Twoje konto zostało usunięte."
                : "";
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Poprzednie hasło jest nieprawidłowe lub nowe hasło jest niepoprawne.");
                    }
                }
            }
            else
